...
class TestOWPolar(WidgetTest):
    ...
    def test_multifile_in(self):
        ...
        self.pol_widget.feats = [self.pol_widget.feat_view.model()[:][2],
                                 self.pol_widget.feat_view.model()[:][3]]
    ...
    def test_multi_inputs(self):
        ...
        self.pol_widget.feats = [self.pol_widget.feat_view.model()[:][2],
                                 self.pol_widget.feat_view.model()[:][3]]
        self.assertEqual(self.pol_widget.feats[0],
                         self.in1.domain.metas[2].copy(compute_value=None))
        self.assertEqual(self.pol_widget.feats[1],
